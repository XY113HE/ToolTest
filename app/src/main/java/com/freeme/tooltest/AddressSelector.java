...
public class AddressSelector extends LinearLayout implements View.OnClickListener{
    private int TextSelectedColor = Color.parseColor("#0000ff");
    ...
    //列表文字选中的颜色
    private int listTextSelectedColor = Color.parseColor("#0000ff");
    //列表icon资源
     ...
     * 标签控件
     * */
    public class Tab extends androidx.appcompat.widget.AppCompatTextView{
        private int index = 0;
        private int TextSelectedColor = Color.parseColor("#0000ff");
        private int TextEmptyColor = Color.parseColor("#333333");
        /**
    ...
    private class Line extends LinearLayout{
        ...
        private int SelectedColor = Color.parseColor("#0000ff");
